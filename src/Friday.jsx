...
export default function Friday() {
  ...
  const fetchColors = () => {
    axios.get(`${URL}/tableData`)
      .then(response => {
        const tableData = response.data.tableData['วันศุกร์'];
  ...
  return (
    <>
      ...
      <div className="days-menu">
        <h1 className="textday">วันศุกร์</h1>
      </div>

      <div>
        <img className="image-day" src="/public/Pictures/friday.png" width="400px" height="400px" alt="Monday" />
      </div>
