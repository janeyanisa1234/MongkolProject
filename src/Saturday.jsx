...
export default function Monday() {
  ...
  const fetchColors = () => {
    axios.get(`${URL}/tableData`)
      .then(response => {
        const tableData = response.data.tableData['วันเสาร์'];
  ...
  return (
    <>
      ...
      <div className="days-menu">
        <h1 className="textday">วันเสาร์</h1>
      </div>

      <div>
        <img className="image-day" src="/public/Pictures/saturday.png" width="400px" height="400px" alt="Monday" />
      </div>
